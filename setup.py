...
PACKAGE_DATA = [
    os.path.join(ROOT, "raspberry_pi", "res", "metadata.json"),
    os.path.join(ROOT, "raspberry_pi", "log", ".keep")
]

with open(os.path.join(ROOT, "raspberry_pi", "res", "metadata.json")) as f:
